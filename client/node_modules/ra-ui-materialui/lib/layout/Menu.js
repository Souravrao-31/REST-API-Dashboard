...
var Menu = function (props) {
    ...
    return (React.createElement("div", __assign({ className: classnames_1.default(classes.main, (_a = {},
        ...
        resources
            ...
            }, primaryText: translatedResourceName(resource, translate), leftIcon: resource.icon ? React.createElement(resource.icon, null) : React.createElement(ViewList_1.default, null), onClick: onMenuClick, dense: dense, sidebarIsOpen: open })); }),
        isXSmall && logout));
};
Menu.propTypes = {
