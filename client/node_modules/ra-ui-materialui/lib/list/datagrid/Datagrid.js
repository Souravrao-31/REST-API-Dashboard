...
var Datagrid = React.forwardRef(function (props, ref) {
    ...
    var lastSelected = react_1.useRef(null);
    react_1.useEffect(function () {
        if (selectedIds.length === 0) {
            lastSelected.current = null;
        }
    }, [selectedIds.length]);
    var handleToggleItem = react_1.useCallback(function (id, event) {
        ...
        if (event.shiftKey && lastSelectedIndex !== -1) {
            ...
            var newSelectedIds = event.target.checked
                ? union_1.default(selectedIds, idsBetweenSelections)
                : difference_1.default(selectedIds, idsBetweenSelections);
            onSelect(isRowSelectable
