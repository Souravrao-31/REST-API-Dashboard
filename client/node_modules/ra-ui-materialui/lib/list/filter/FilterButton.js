...
var FilterButton = function (props) {
    ...
    var _a = ra_core_1.useListContext(props), _b = _a.displayedFilters, displayedFilters = _b === void 0 ? {} : _b, filterValues = _a.filterValues, showFilter = _a.showFilter;
    ...
    if (hiddenFilters.length === 0)
        return null;
    return (React.createElement("div", __assign({ className: classnames_1.default(classes.root, className) }, sanitizeRestProps(rest)),
