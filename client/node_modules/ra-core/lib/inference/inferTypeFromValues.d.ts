declare const types: readonly ["array", "boolean", "date", "email", "id", "number", "reference", "referenceChild", "referenceArray", "referenceArrayChild", "richText", "string", "url"];
export declare type PossibleInferredElementTypes = typeof types[number];
