...
declare const useInput: ({ defaultValue, id, name, source, validate, onBlur: customOnBlur, onChange: customOnChange, onFocus: customOnFocus, isRequired: isRequiredOption, ...options }: InputProps) => UseInputValue;
